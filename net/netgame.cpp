				   ...
				   PCHAR szPlayerName, PCHAR szPass)
{
	...
	if(pChatWindow) {
		pChatWindow->AddInfoMessage("Welcome to Vice Unleashed 0.1");
		pChatWindow->AddDebugMessage("Connecting to server %s:%d...",szHostOrIp,iPort);
	}
...
{
	if(pChatWindow) {
		pChatWindow->AddDebugMessage("Connection Confirmed... Loading game");
	}
